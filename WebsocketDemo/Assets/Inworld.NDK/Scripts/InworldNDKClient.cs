...
#pragma warning restore CS4014
        ...
        public override void SendAudio(string charID, string base64)
        {
            ...
            //Debug.Log("sending audio data to NDK data length is " + data.Length);
...
VSAttribution.VSAttribution.SendAttributionEvent("Login Runtime", InworldAI.k_CompanyName, InworldAI.User.Account);
        ...
        {
            Debug.Log("LoadSceneAsync agentinfo count: " + agentInfoArray.AgentInfoList.Count);
            ...
            Debug.Log("after for loop in loadasync agentcount is " + m_LoadSceneResponse.agents.Count);
            ...
            Debug.Log("LoadSceneAsync agentinfo after status update: " + agentInfoArray.AgentInfoList.Count);
