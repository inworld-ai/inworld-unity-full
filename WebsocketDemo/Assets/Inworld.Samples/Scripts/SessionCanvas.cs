...
namespace Inworld.Sample
{
    public class SessionCanvas : DemoCanvas
    {
        ...
        void Awake()
        {
            ...
            //     ipv4 = Dns.GetHostAddresses(InworldController.Client.m_ServerConfig.RuntimeServer)[0].ToString();
        ...
        {
            if(InworldController.Instance.CurrentCharacter.Interaction is InworldAudioInteraction)
                (InworldController.Instance.CurrentCharacter.Interaction as InworldAudioInteraction).IsMute = m_Mute.isOn;
        }
