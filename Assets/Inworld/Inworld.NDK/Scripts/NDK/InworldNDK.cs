...
#region Callback
            ...
            {
                if (InworldController.Client is InworldNDKClient ndkClient)
                    ndkClient.Enqueue(From.NDKTextPacket(packet));
            }
            ...
            static void OnPhonemeReceived(PhonemeInfo packet)
            {
                ...
                {
                    if (InworldController.Client is InworldNDKClient ndkClient)
                        ndkClient.Enqueue(From.NDKAudioChunk());
                }
            }   
#endregion
        }
